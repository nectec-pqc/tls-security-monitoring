...
class EndPoint(SQLModel):
    ...
    valid_after: datetime # use to track date that this end point start to alive 
    valid_before: datetime # use to track date that this end poin die
